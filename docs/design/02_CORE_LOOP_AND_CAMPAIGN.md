...
```mermaid
flowchart TD
    Campaign[Campaign Outcomes]
    Shelter[Shelter / Authored Station]
    Rooms[Rooms & Equipment]
    Construction[Construction & Reclamation]
    Utilities[Utilities: Power / Air / Water / Structure]
    Resources[Stocks & Detailed Items]
    Residents[Named Residents]
    Tasks[Tasks & Assignments]
    Needs[Health / Hunger / Fatigue / Stress]
    Health[Injury, Illness & Recovery]
    Signals[Signals / Listening Post]
    Expeditions[Nightrun Graphs]
    Visitors[Visitors & Traders]
    Factions[Factions]
    Memories[Memories]
    Relationships[Relationships]
    Promises[Promises & Boundaries]
    Incidents[Incidents & Failure Cascades]
    ...
    Expeditions --> Health
    Expeditions --> Memories
    Expeditions --> Visitors
    Visitors --> Resources
    Visitors --> Residents
    Visitors --> Factions
    Factions --> Signals
