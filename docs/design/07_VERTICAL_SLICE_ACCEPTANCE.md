...
- [ ] At least one Accord threshold crossing occurs in normal play, and the correct (warm/withheld) canteen scene variant triggers — while the unconditional hope-floor beats fire regardless of Accord (see §13).
